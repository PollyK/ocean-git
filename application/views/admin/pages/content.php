<div id="container">
    <div id="sidebar">
        <ul class="sideNav">
            <li><a href="#"></a></li>
            <li><a href="#" class="active">Создать новый раздел</a></li>
            <li><a href="#">Удалить раздел</a></li>
            <li><a href="#">Переименовать</a></li>
            <li><a href="#">Редактировать текст</a></li>
            <li><a href="#">Переименовать раздел</a></li>
            <li><a href="#">Вкл/откл раздел</a></li>
        </ul>
    </div>    

    <h2><a href="#">Структура сайта</a> &raquo; 
        <a href="#" class="active">Разделы сайта</a></h2>
